...
<script language="javascript">
	...
	// The Full frame ... display full screen while events active ... 
	...
	stream = {
		...
		start_time: 0,				// The start time in ms for the current view
		motion_detected: false,			// Set to true when motion first detected
		scan_count: 0,				// The number of scan cycles
