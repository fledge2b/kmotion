...
*/
	...
	function fq_filename()  // return a fully qualified path & filename from image object
	{
		...
		{
			pathnfile = "motion/" + archive.selected_date + "/" + zero_fill(archive.selected_feed) + "/video/" + secs_time(image.jpeg_secs) + "/" + zero_fill(image.jpeg_frame) + ".jpg";
		}			
		else			// snap
		{
			pathnfile = "motion/" + archive.selected_date + "/" + zero_fill(archive.selected_feed) + "/video/" + secs_time(image.jpeg_secs) + ".jpg";
		}
		return pathnfile;
	}
